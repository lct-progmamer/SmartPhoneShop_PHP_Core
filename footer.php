            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="contact">
                        ...
                        <p><i class="fa fa-map-marker"> Địa chỉ: Đại học Công Nghiệp Hà Nội</i></p>
                        <p><i class="fa fa-phone"> 0987654321</i></p>
                        <p><i class="fa fa-envelope"> Nhom8@gmail.com</i></p>
                        <div class="mxh">
                ...
                <div class="col-lg-3">
                    <div class="download">
                        ...
                        <p>Ứng dụng My Phone hiện có sẵn trên Google Play & App Store. Tải nó ngay.</p>
                        <p><a href="#"><img src="images/dp.jpg" alt=""></a></p>

                        <p><a href="#"><img src="images/da.jpg" alt=""></a></p>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="map">
