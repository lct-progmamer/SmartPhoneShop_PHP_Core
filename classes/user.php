...
class user
{
	...
	public function insert($data)
	{
		...
		if ($result_check) {
			...
			if ($result) {
				...
				// $mail->Username   = "lechitai1232018@gmail.com";
				// $mail->Password   = "Lechitai2001";

				// $mail->IsHTML(true);
				// $mail->CharSet = 'UTF-8';
				// $mail->AddAddress($email, "recipient-name");
				// $mail->SetFrom("lechitai1232018@gmail.com", "SmartPhone Store");
				// $mail->Subject = "Xác nhận email tài khoản - SmartPhone Store";
				// $mail->Body = "<h3>Cảm ơn bạn đã đăng ký tài khoản tại website SmartPhone Nhóm 8</h3></br>Đây là mã xác minh tài khoản của bạn: " . $captcha . "";
	...
	public function confirm($userId, $captcha)
	{
		...
		return '<p style:"color : red">Mã xác minh không đúng!</p>';
	}
}
?>